...
-modded bios and fastboot (Removed in 1.5)
-And a custom gpu (with modfied 3d model) since v 1.5
==================================================================================
...
1.4.1
-Added a couple phenom II x6 cpu's
1.5
-Updated the mod to the lates pcbs version (1.14.1)
-Added a custom gpu with modfied 3d model (as far as i know this mod is the only one with something liek this)
-Remade the Mainboards because of some weird bugs that broke everything
-Removed fast boot because i couldn't finish it in time (will maybe added in a later version)
=============================================================================
Questions
=========
Q:Is this Mod free?
